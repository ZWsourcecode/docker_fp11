...
command = ["/flexpart/setattribute_mon_eu.sh", ATT_PATH, OUT_FOLDER]
...
merge_month(MONTH_PATH, Station.upper(), date_object, domain="eu")
...
cal_ffco2(PATH_FF, ATT_PATH, Station, Year, Month, Day, domain="eu", upload=True)
